...
usersRoutes.get('/:id', [auth_1.default, admin_1.default], (0, error_handler_1.errorHandler)(users_1.getUserId));
usersRoutes.put('/role/:id', [auth_1.default, admin_1.default], (0, error_handler_1.errorHandler)(users_1.changeUserRole));
